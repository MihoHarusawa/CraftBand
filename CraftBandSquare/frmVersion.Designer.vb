...
Partial Class frmVersion
    ...
    Private Sub InitializeComponent()
        ...
        lblExeName.Size = New Size(112, 19)
        lblExeName.TabIndex = 27
        lblExeName.Text = "CraftBandSquare"
        ' 
        ' lblDescription
        ' 
        ...
        lblDescription.Size = New Size(120, 19)
        lblDescription.TabIndex = 28
        lblDescription.Text = "四つ目かごのデザイン"
        ' 
        ' txtDescription
        ' 
        ...
        txtDescription.Text = "四つ目" & vbCrLf & "水平・垂直にクロスしてできる「四角」を" & vbCrLf & "ベースに底と側面を編んでいくタイプです。"
        ' 
        ' lblVersion
        ' 
        ...
        lnkLabo.Size = New Size(288, 19)
        lnkLabo.TabIndex = 33
        lnkLabo.TabStop = True
        lnkLabo.Text = "https://labo.com/CraftBand/CraftBandSquare/"
        ' 
        ' frmVersion
        ' 
