...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        Friend ReadOnly Property LOG_MasterConfigFile() As String
            Get
                Return ResourceManager.GetString("LOG_MasterConfigFile", resourceCulture)
            End Get
        End Property
        ...
        '''<summary>
        '''  なし,左下,中心,座標 に類似しているローカライズされた文字列を検索します。
        '''</summary>
        ...
        '''<summary>
        '''  横バンド,横四角,正方形(辺),長方形(横),円(径),楕円(横径),上半円(径),正方形(周),長方形(周),円(周),楕円(周),上半円(周),横線,縦線,線分,点,バンド に類似しているローカライズされた文字列を検索します。
        '''</summary>
