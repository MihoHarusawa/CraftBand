...
Partial Class frmSettings
    ...
    Private Sub InitializeComponent()
        ...
        btn終了.Location = New Point(290, 133)
        btn終了.Name = "btn終了"
        ...
        btn実行ファイルフォルダ.Location = New Point(371, 101)
        ...
        txt実行ファイルフォルダ.Size = New Size(228, 26)
        ...
        lbl実行ファイルフォルダ.Visible = False
        ' 
        ' chkアプリを起動したら閉じる
        ' 
        chkアプリを起動したら閉じる.AutoSize = True
        chkアプリを起動したら閉じる.Location = New Point(137, 16)
        ...
        chk画面の表示を残す.Location = New Point(137, 78)
        ...
        chk編集対象なしで起動する.Location = New Point(137, 47)
        ...
        ' picGear
        ' 
        picGear.Image = CType(resources.GetObject("picGear.Image"), Image)
        picGear.InitialImage = CType(resources.GetObject("picGear.InitialImage"), Image)
        picGear.Location = New Point(42, 33)
        picGear.Name = "picGear"
        picGear.Size = New Size(48, 48)
        picGear.SizeMode = PictureBoxSizeMode.AutoSize
        picGear.TabIndex = 7
        ...
        Text = "設定"
        CType(picGear, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
        PerformLayout()
