...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        btn概算.Location = New Point(749, 130)
        btn概算.Name = "btn概算"
        ...
        btnひもリスト.Location = New Point(757, 660)
        ...
        lbl垂直ひも数.Location = New Point(366, 636)
        ...
        txt垂直ひも数.Location = New Point(453, 634)
        txt垂直ひも数.Name = "txt垂直ひも数"
        txt垂直ひも数.ReadOnly = True
        txt垂直ひも数.Size = New Size(80, 26)
        ...
        nudひも長加算_縦横.Location = New Point(578, 124)
        ...
        nudひも長加算_縦横.Size = New Size(69, 26)
        ...
        lblひも長加算_縦横端.Location = New Point(447, 127)
        ...
        btn規定値.Location = New Point(632, 130)
        btn規定値.Name = "btn規定値"
        ...
        btnリセット.Location = New Point(515, 130)
        ...
        txtコマベース_横.Location = New Point(453, 697)
        txtコマベース_横.Name = "txtコマベース_横"
        txtコマベース_横.ReadOnly = True
        txtコマベース_横.Size = New Size(79, 26)
        txtコマベース_横.TabIndex = 45
        ...
        txtコマベース_縦.Location = New Point(539, 697)
        txtコマベース_縦.Name = "txtコマベース_縦"
        txtコマベース_縦.ReadOnly = True
        txtコマベース_縦.Size = New Size(79, 26)
        txtコマベース_縦.TabIndex = 48
        ...
        txtコマベース_高さ.Location = New Point(625, 697)
        txtコマベース_高さ.Name = "txtコマベース_高さ"
        txtコマベース_高さ.ReadOnly = True
        txtコマベース_高さ.Size = New Size(79, 26)
        txtコマベース_高さ.TabIndex = 51
        ...
        txt縁厚さプラス_横.Location = New Point(453, 726)
        ...
        txt縁厚さプラス_縦.Location = New Point(539, 726)
        ...
        txt縁厚さプラス_高さ.Location = New Point(625, 726)
        ...
        txtコマベース_周.Location = New Point(712, 697)
        txtコマベース_周.Name = "txtコマベース_周"
        txtコマベース_周.ReadOnly = True
        txtコマベース_周.Size = New Size(79, 26)
        txtコマベース_周.TabIndex = 55
        ...
        txt縁厚さプラス_周.Location = New Point(712, 726)
        ...
        lbl高さのコマ.Location = New Point(54, 261)
        lbl高さのコマ.Name = "lbl高さのコマ"
        lbl高さのコマ.Size = New Size(64, 19)
        ...
        lbl寸法.AutoSize = True
        lbl寸法.Location = New Point(24, 699)
        lbl寸法.Name = "lbl寸法"
        lbl寸法.Size = New Size(37, 19)
        lbl寸法.TabIndex = 31
        lbl寸法.Text = "寸法"
        ...
        lblコマ.AutoSize = True
        lblコマ.Location = New Point(101, 669)
        lblコマ.Name = "lblコマ"
        lblコマ.Size = New Size(30, 19)
        lblコマ.TabIndex = 33
        lblコマ.Text = "コマ"
        ...
        lblコマベース.Location = New Point(169, 669)
        lblコマベース.Name = "lblコマベース"
        lblコマベース.Size = New Size(76, 19)
        ...
        lbl厚さ.AutoSize = True
        lbl厚さ.Location = New Point(568, 636)
        lbl厚さ.Name = "lbl厚さ"
        ...
        txt厚さ.Location = New Point(625, 634)
        txt厚さ.Name = "txt厚さ"
        txt厚さ.ReadOnly = True
        txt厚さ.Size = New Size(80, 26)
        txt厚さ.TabIndex = 30
        ...
        lbl縦のコマ数.Location = New Point(30, 42)
        lbl縦のコマ数.Name = "lbl縦のコマ数"
        lbl縦のコマ数.Size = New Size(69, 19)
        lbl縦のコマ数.TabIndex = 0
        lbl縦のコマ数.Text = "縦のコマ数"
        ...
        lbl横のコマ数.Location = New Point(26, 41)
        lbl横のコマ数.Name = "lbl横のコマ数"
        lbl横のコマ数.Size = New Size(69, 19)
        lbl横のコマ数.TabIndex = 0
        lbl横のコマ数.Text = "横のコマ数"
        ...
        txt1コマ_要尺.Location = New Point(86, 726)
        ...
        txt1コマ_寸法.Location = New Point(86, 697)
        ...
        lbl要尺.AutoSize = True
        lbl要尺.Location = New Point(24, 729)
        lbl要尺.Name = "lbl要尺"
        lbl要尺.Size = New Size(37, 19)
        lbl要尺.TabIndex = 32
        lbl要尺.Text = "要尺"
        ...
        txtコマベース_要尺.Location = New Point(171, 726)
        ...
        txtコマベース_寸法.Location = New Point(171, 697)
        ...
        lbl折り返しのコマ.Location = New Point(54, 299)
        lbl折り返しのコマ.Name = "lbl折り返しのコマ"
        lbl折り返しのコマ.Size = New Size(89, 19)
        ...
        lbl開始位置.Location = New Point(26, 85)
        lbl開始位置.Name = "lbl開始位置"
        lbl開始位置.Size = New Size(65, 19)
        lbl開始位置.TabIndex = 3
        lbl開始位置.Text = "開始位置"
        ...
        lbl開始位置_u.Location = New Point(30, 86)
        lbl開始位置_u.Name = "lbl開始位置_u"
        lbl開始位置_u.Size = New Size(65, 19)
        ...
        ' txt横ひもの本数
        ' 
        txt横ひもの本数.Location = New Point(160, 127)
        txt横ひもの本数.Name = "txt横ひもの本数"
        txt横ひもの本数.ReadOnly = True
        txt横ひもの本数.Size = New Size(68, 26)
        txt横ひもの本数.TabIndex = 8
        txt横ひもの本数.TextAlign = HorizontalAlignment.Center
        ToolTip1.SetToolTip(txt横ひもの本数, "横に置かれるひもの本数")
        ' 
        ' lbl横ひも
        ' 
        lbl横ひも.AutoSize = True
        lbl横ひも.Location = New Point(26, 128)
        lbl横ひも.Name = "lbl横ひも"
        lbl横ひも.Size = New Size(45, 19)
        lbl横ひも.TabIndex = 7
        lbl横ひも.Text = "横ひも"
        ...
        ' txt縦ひもの本数
        ' 
        txt縦ひもの本数.Location = New Point(163, 129)
        txt縦ひもの本数.Name = "txt縦ひもの本数"
        txt縦ひもの本数.ReadOnly = True
        txt縦ひもの本数.Size = New Size(68, 26)
        txt縦ひもの本数.TabIndex = 8
        txt縦ひもの本数.TextAlign = HorizontalAlignment.Center
        ToolTip1.SetToolTip(txt縦ひもの本数, "縦に置かれるひもの本数")
        ' 
        ' lbl縦ひも
        ' 
        lbl縦ひも.AutoSize = True
        lbl縦ひも.Location = New Point(30, 132)
        lbl縦ひも.Name = "lbl縦ひも"
        ...
        lblコマ上側の縦ひも.Location = New Point(447, 44)
        lblコマ上側の縦ひも.Name = "lblコマ上側の縦ひも"
        lblコマ上側の縦ひも.Size = New Size(105, 19)
        ...
        ' 
        rad右側.AutoSize = True
        rad右側.Location = New Point(737, 43)
        rad右側.Name = "rad右側"
        rad右側.Size = New Size(55, 23)
        rad右側.TabIndex = 3
        rad右側.Text = "右側"
        ...
        ' 
        rad左側.AutoSize = True
        rad左側.Location = New Point(666, 43)
        rad左側.Name = "rad左側"
        rad左側.Size = New Size(55, 23)
        rad左側.TabIndex = 2
        rad左側.Text = "左側"
        ...
        radどちらでも.Location = New Point(577, 43)
        radどちらでも.Name = "radどちらでも"
        radどちらでも.Size = New Size(78, 23)
        radどちらでも.TabIndex = 1
        ...
        nudひも長加算_側面.Location = New Point(194, 362)
        ...
        lblひも長加算_側面.Location = New Point(54, 363)
        lblひも長加算_側面.Name = "lblひも長加算_側面"
        lblひも長加算_側面.Size = New Size(109, 19)
        lblひも長加算_側面.TabIndex = 19
        ...
        lbl左から.Location = New Point(101, 85)
        lbl左から.Name = "lbl左から"
        lbl左から.Size = New Size(44, 19)
        lbl左から.TabIndex = 4
        lbl左から.Text = "左から"
        ...
        lbl上から.Location = New Point(105, 86)
        lbl上から.Name = "lbl上から"
        lbl上から.Size = New Size(44, 19)
        lbl上から.TabIndex = 4
        lbl上から.Text = "上から"
        ...
        ' txt編みひも
        ' 
        txt編みひも.Location = New Point(194, 401)
        txt編みひも.Name = "txt編みひも"
        txt編みひも.ReadOnly = True
        txt編みひも.Size = New Size(68, 26)
        txt編みひも.TabIndex = 23
        txt編みひも.TextAlign = HorizontalAlignment.Center
        ToolTip1.SetToolTip(txt編みひも, "側面を編むひもの本数")
        ' 
        ' lbl編みひも
        ' 
        lbl編みひも.AutoSize = True
        lbl編みひも.Location = New Point(54, 400)
        lbl編みひも.Name = "lbl編みひも"
        lbl編みひも.Size = New Size(57, 19)
        lbl編みひも.TabIndex = 22
        lbl編みひも.Text = "編みひも"
        ...
        ' chk斜め立ち上げ
        ' 
        chk斜め立ち上げ.AutoSize = True
        chk斜め立ち上げ.Location = New Point(195, 333)
        chk斜め立ち上げ.Name = "chk斜め立ち上げ"
        chk斜め立ち上げ.Size = New Size(103, 23)
        chk斜め立ち上げ.TabIndex = 18
        chk斜め立ち上げ.Text = "斜め立ち上げ"
        ToolTip1.SetToolTip(chk斜め立ち上げ, "チェックONで斜めに立ち上げます" & vbCrLf & "編みひもの情報は失われますのでご注意ください")
        chk斜め立ち上げ.UseVisualStyleBackColor = True
        ' 
        ' chkコマ枠
        ' 
        ...
        ' lbl対角サイズ
        ' 
        lbl対角サイズ.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left
        lbl対角サイズ.AutoSize = True
        lbl対角サイズ.Location = New Point(261, 669)
        lbl対角サイズ.Name = "lbl対角サイズ"
        lbl対角サイズ.Size = New Size(68, 19)
        lbl対角サイズ.TabIndex = 39
        lbl対角サイズ.Text = "対角サイズ"
        ToolTip1.SetToolTip(lbl対角サイズ, "斜め立ち上げの時の単位サイズ")
        lbl対角サイズ.Visible = False
        ' 
        ' txtコマベース_対角
        ' 
        txtコマベース_対角.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left
        txtコマベース_対角.Location = New Point(256, 726)
        txtコマベース_対角.Name = "txtコマベース_対角"
        ...
        ' txtコマ_対角
        ' 
        txtコマ_対角.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left
        txtコマ_対角.Location = New Point(256, 697)
        txtコマ_対角.Name = "txtコマ_対角"
        ...
        ToolStripMenuItemSettingGauge.Size = New Size(163, 24)
        ...
        TabControl.Size = New Size(848, 465)
        ...
        tpageコマ数.Size = New Size(840, 433)
        tpageコマ数.TabIndex = 0
        tpageコマ数.Text = "コマ数"
        ...
        lbl編みひも_単位.Location = New Point(267, 403)
        lbl編みひも_単位.Name = "lbl編みひも_単位"
        lbl編みひも_単位.Size = New Size(23, 19)
        lbl編みひも_単位.TabIndex = 24
        lbl編みひも_単位.Text = "本"
        ' 
        ' lblひも長加算_側面_単位
        ' 
        lblひも長加算_側面_単位.AutoSize = True
        lblひも長加算_側面_単位.Location = New Point(267, 363)
        lblひも長加算_側面_単位.Name = "lblひも長加算_側面_単位"
        lblひも長加算_側面_単位.Size = New Size(33, 19)
        lblひも長加算_側面_単位.TabIndex = 21
        lblひも長加算_側面_単位.Text = "mm"
        ' 
        ' lbl折り返しコマ数_単位
        ' 
        lbl折り返しコマ数_単位.AutoSize = True
        lbl折り返しコマ数_単位.Location = New Point(267, 299)
        lbl折り返しコマ数_単位.Name = "lbl折り返しコマ数_単位"
        lbl折り返しコマ数_単位.Size = New Size(23, 19)
        ...
        lbl高さのコマ数_単位.Location = New Point(267, 261)
        lbl高さのコマ数_単位.Name = "lbl高さのコマ数_単位"
        lbl高さのコマ数_単位.Size = New Size(23, 19)
        ...
        lblひも長加算_縦横_単位.Location = New Point(658, 127)
        lblひも長加算_縦横_単位.Name = "lblひも長加算_縦横_単位"
        lblひも長加算_縦横_単位.Size = New Size(33, 19)
        ...
        lblコマ間のすき間_単位.Location = New Point(658, 86)
        lblコマ間のすき間_単位.Name = "lblコマ間のすき間_単位"
        lblコマ間のすき間_単位.Size = New Size(33, 19)
        ...
        grp縦置き.Location = New Point(415, 170)
        grp縦置き.Name = "grp縦置き"
        grp縦置き.Size = New Size(381, 218)
        grp縦置き.TabIndex = 11
        ...
        lbl縦ひもの本数_単位.Location = New Point(243, 132)
        ...
        lbl番目のコマ_u.Location = New Point(243, 86)
        lbl番目のコマ_u.Name = "lbl番目のコマ_u"
        lbl番目のコマ_u.Size = New Size(69, 19)
        ...
        lbl縦ひものメモ.Location = New Point(30, 176)
        ...
        ' txt縦ひものメモ
        ' 
        txt縦ひものメモ.Location = New Point(163, 174)
        txt縦ひものメモ.Name = "txt縦ひものメモ"
        txt縦ひものメモ.Size = New Size(201, 26)
        txt縦ひものメモ.TabIndex = 11
        ' 
        ' lbl縦のコマ数_単位
        ' 
        lbl縦のコマ数_単位.AutoSize = True
        lbl縦のコマ数_単位.Location = New Point(243, 42)
        lbl縦のコマ数_単位.Name = "lbl縦のコマ数_単位"
        lbl縦のコマ数_単位.Size = New Size(23, 19)
        ...
        lbl横ひもの本数_単位.Location = New Point(240, 128)
        ...
        lbl番目のコマ_l.Location = New Point(240, 85)
        lbl番目のコマ_l.Name = "lbl番目のコマ_l"
        lbl番目のコマ_l.Size = New Size(69, 19)
        ...
        lbl横ひものメモ.Location = New Point(26, 172)
        ...
        ' txt横ひものメモ
        ' 
        txt横ひものメモ.Location = New Point(160, 170)
        txt横ひものメモ.Name = "txt横ひものメモ"
        txt横ひものメモ.Size = New Size(201, 26)
        txt横ひものメモ.TabIndex = 11
        ' 
        ' lbl横のコマ数_単位
        ' 
        lbl横のコマ数_単位.AutoSize = True
        lbl横のコマ数_単位.Location = New Point(240, 41)
        lbl横のコマ数_単位.Name = "lbl横のコマ数_単位"
        lbl横のコマ数_単位.Size = New Size(23, 19)
        ...
        tpage側面と縁.Size = New Size(840, 433)
        ...
        dgv側面と縁.Columns.AddRange(New DataGridViewColumn() {f_i番号2, f_s編みかた名2, f_s編みひも名2, f_iひも番号2, f_i何本幅2, f_i周数2, f_s色2, f_b集計対象外区分2, f_b周連続区分2, f_b次周連続区分2, f_i段数, f_d高さ2, f_d高さ比率2, f_d垂直ひも長2, f_d周長比率対底の周2, f_d周長2, f_dひも長2, f_dひも長加算2, f_iひも本数2, f_d連続ひも長2, f_d厚さ2, f_s記号2, f_i表示順2, f_i非表示順2, f_sメモ2, f_bError2})
        dgv側面と縁.DataSource = BindingSource側面と縁
        dgv側面と縁.Location = New Point(6, 5)
        ...
        tpage追加品.Size = New Size(840, 433)
        tpage追加品.TabIndex = 3
        tpage追加品.Text = "追加品"
        ...
        tpageメモ他.Size = New Size(840, 433)
        tpageメモ他.TabIndex = 4
        tpageメモ他.Text = "メモ他"
        ...
        tpage横ひも.Size = New Size(840, 433)
        tpage横ひも.TabIndex = 5
        tpage横ひも.Text = "横ひも"
        ...
        tpage縦ひも.Size = New Size(840, 433)
        tpage縦ひも.TabIndex = 6
        tpage縦ひも.Text = "縦ひも"
        ...
        tpageプレビュー.Size = New Size(840, 433)
        ...
        tpageプレビュー2.Size = New Size(840, 433)
        ...
        lblコマ寸法ベース.Location = New Point(358, 699)
        lblコマ寸法ベース.Name = "lblコマ寸法ベース"
        lblコマ寸法ベース.Size = New Size(90, 19)
        lblコマ寸法ベース.TabIndex = 42
        ...
        lbl計算寸法.Location = New Point(23, 636)
        ...
        lbl計算寸法縦.Location = New Point(568, 669)
        ...
        lbl計算寸法高さ.Location = New Point(646, 669)
        ...
        lbl計算寸法_単位.Location = New Point(159, 636)
        ...
        lbl縁厚さプラス.Location = New Point(358, 729)
        ...
        lbl計算寸法横.Location = New Point(478, 669)
        ...
        lbl計算寸法周.Location = New Point(741, 669)
        ...
        btn終了.Location = New Point(757, 708)
        btn終了.Name = "btn終了"
        ...
        lbl単位.AutoSize = True
        lbl単位.Location = New Point(98, 636)
        lbl単位.Name = "lbl単位"
        ...
        btnDEBUG.Location = New Point(758, 630)
        ...
        ClientSize = New Size(888, 793)
        Controls.Add(lbl対角サイズ)
        Controls.Add(txtコマベース_対角)
        Controls.Add(txtコマ_対角)
