...
#Region "基本的な画面処理"
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        expand横ひも.SetNames(Me.Text, tpage横ひも.Text, False, ctrExpanding.enumVisible.i_出力ひも長, My.Resources.CaptionExpand8To2, My.Resources.CaptionExpand4To6)
        expand縦ひも.SetNames(Me.Text, tpage縦ひも.Text, False, ctrExpanding.enumVisible.i_出力ひも長, My.Resources.CaptionExpand4To6, My.Resources.CaptionExpand8To2)
...
#Region "ステップ画像・ヘッドレス実行"
    ...
    Public Function MakeImageFile(ByVal n As Integer, ByVal col As String, ByVal fpath As String, ByRef msg As String
        ...
        Dim calc As New clsCalcKnot(data, Me)
    ...
    Public Function MakeImageFile2(ByVal n As Integer, ByVal col As String, ByVal fpath As String, ByVal isShow3D As Boolean, ByRef msg As String
        ...
        Dim stepModelImageData As New clsModelKnot(calc, Nothing)
        Dim ret As Boolean = stepModelImageData.CalcModel(Me)
    ...
    Public Function MakeImageFile(ByVal fpath As String, ByRef msg As String
        ...
        If Not _clsCalcKnot.CalcSize(CalcCategory.NewData, Nothing, Nothing) Then
    ...
    Public Function MakeImageFile2(ByVal fpath As String, ByVal saveDir As String, ByRef msg As String
        ...
        Dim modelImageData As New clsModelKnot(_clsCalcKnot, Nothing)
...
#Region "追加品"
    ...
    Sub setAddPartsRefNames()
        ...
        For i = 1 To 4
            ...
            names(i) = names(i) & "/" & lblコマ寸法ベース.Text
        Next
    ...
    Sub Show追加品(ByVal works As clsDataTables)
        ...
        '追加品の参照値 #63
        editAddParts.ShowGrid(works, _clsCalcKnot.getAddPartsRefValues)
